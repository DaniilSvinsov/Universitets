...
itog = ['muctr', 'mtusi', 'sut', 'skfmtusi', 'vvfmtuci', 'urfu', 'mgtu', 'spbstu', 'sfu', 'mirea', 'kfu', 'hse', 'fu', 'sfedu', 'mai', 'dvfu', 'spbgu', 'knitu', 'mospolytech', 'miit', 'cfuv', 'donstu', 'svfu', 'tgu', 'mpei', 'unn', 'mgmu', 'nstu', 'ssau', 'tiu', 'rusoil', 'kubsu', 'susu', 'spbguap', 'mgpu', 'sibsau', 'belgu', 'cchgeu', 'timacad', 'pstu', 'itmo', 'ncfu', 'eltech', 'herzen', 'mpgu', 'narfu', 'spmi', 'altsu', 'sgu', 'samgtu', 'gubkina', 'mgsu', 'tpu', 'vsu', 'omgtu', 'kantiana', 'tumgu', 'psu', 'pirogova', 'mifi', 'mfti', 'rudn', 'mrsu', 'mgua', 'vyatsu', 'isu', 'nspu', 'sevsu', 'kai', 'bspu', 'chesu', 'istu', 'oreluniver', 'pnzgu', 'marsu', 'tsutula', 'nsu', 'volgatech.net', 'chuvsu', 'ugatu', 'kemsu', 'tusur', 'pnu', 'bashgu', 'petrsu', 'novsu', 'mgutu', 'udsu', 'nntu', 'kgeu', 'magtu', 'mgupp', 'rsuh', 'osu', 'sutd', 'bstu', 'vlsu', 'reu', 'tsutmb', 'stankin', 'mglu', 'chsu', 'uspu', 'volsu', 'ranepa', 'vstu', 'voenmeh', 'pgups', 'kubsau', 'mgou', 'tsput', 'sibsiu', 'npitu', 'ngpu_minin', 'smtu', 'spbgasu', 'kosygin', 'kubstu', 'chspu', 'altstu', 'spbftu', 'sstu', 'kursksu', 'kspu', 'syktsu', 'ospu', 'dgu', 'spbgti', 'asu', 'bsau', 'kbsu', 'rsreu', 'mgmsu', 'hse', 'ssmu', 'gpmu', 'volgspu', 'bashgmu', 'izstu', 'gstou', 'pgsga', 'vspu', 'altspu', 'yagpu', 'rostgmu', 'rgsu', 'zabgu', 'pskgu', 'tversu', 'miet', 'misis', 'tubryansk', 'omgpu', 'vsau', 'sibsutis', 'nsau', 'stgmu', 'surgu', 'psuti', 'uniyarac', 'mordgpi', 'csu', 'bsu', 'ulsu', 'ksuedu', 'cspu', 'rsuedu', 'vgltu', 'inggu', 'pspu', 'ulspu', 'ystu', 'ulstu', 'sgmu', 'omsu', 'vogu', 'tspu', 'rgups', 'swsu', 'omgau', 'agpu', 'dgmu', 'tuvsu', 'sgau', 'ispu', 'madi', 'klgtu', 'tsuab', 'tltsu', 'usma', 'volgmed', 'omgups', 'tksu', 'pimunn', 'rsvpu', 'mstuca', 'kuzstu', 'samsmu', 'stgau', 'sgua', 'brgu', 'usla', 'usfeu', 'sibadi', 'spbgmu', 'kgasu', 'dgunh', 'lgu_pushkin', 'ugrasu', 'rzgmu', 'khsu', 'krasgmu', 'szgmu', 'knastu', 'esstu', 'kurskmed', 'krasgau', 'chgpu', 'kalmgu', 'samgups', 'sgugit', 'tatngpi', 'volgau', 'mgimo', 'tstu', 'vsmaburdenko', 'tstutver', 'dagsau', 'dvgups', 'usurt', 'ngmu', 'mgau', 'stulipetsk', 'yuurgau', 'kipu', 'tyumsmu', 'kgsu', 'penzgtu', 'kgufkst', 'urgau', 'ksai', 'hse', 'ksma', 'nosu', 'miigaik', 'msun', 'mgppu', 'chelsma', 'dstu', 'ggpi', 'kgmu', 'nngasu', 'mkgtu', 'kchgu', 'astu', 'irgups', 'mstu', 'kemsmu', 'ugtu', 'irsau', 'orgma', 'asau', 'vsuet', 'uvauga', 'adygnet', 'spbgeu', 'guu', 'bsaa', 'sibstrin', 'yagmu', 'spbguga', 'pgsha', 'spbgik', 'ursmu', 'asmu', 'igma', 'bigpibiysk', 'stu', 'izhgsha', 'vsuwt', 'rshu', 'smolgu', 'skgmigtu', 'nsuem', 'bgsha', 'shgpiedu', 'isuct', 'elsu', 'ismu', 'kazgau', 'spbguvm', 'psma', 'osma', 'nsmu', 'fesmu', 'gasu', 'vavt', 'bgu', 'mgik', 'tsaa', 'aumsu', 'agatu', 'tgmu', 'tvgmu', 'stroganov', 'molochnoe', 'pgu', 'amgpgu', 'nnsaa', 'sutr', 'rta', 'dalrybvtuz', 'ivgpu', 'kirovgma', 'nvsu', 'mgri', 'sakhgu', 'ssuwt', 'chitgma', 'ivanovoac', 'ulsau', 'dalgau', 'sogma', 'kazgik', 'lspulipetsk', 'gief', 'bgpu', 'orelsau', 'brstu', 'vvsu', 'gorskigau', 'ranepa', 'surgpu', 'unitechmo', 'vgafk', 'masu', 'academy21', 'rsatu', 'smolgmu', 'pgau', 'rgatu', 'sgafkst', 'vgsha', 'hseperm', 'mgavm', 'kgsxa', 'isma', 'sspi', 'kgsha', 'dongau', 'bryanskgsha', 'astrahangmu', 'kazanveterinary', 'ssaa', 'svgu', 'orensau', 'guz', 'lunn', 'rguts', 'almazovcentre', 'ksaazaural', 'kbgau', 'sseu', 'pgusa', 'bgitu', 'bgiik', 'kemguki', 'amursma', 'spcpu', 'altgaki', 'orelgiet', 'chgik', 'tvgsha', 'norvuz', 'angtu', 'niuranepa', 'ngieu', 'vsgaki', 'agnirt', 'pushkin', 'primacad', 'rsue', 'vgiik', 'ivgsha', 'yaragrovuz', 'kamgu', 'dksta', 'usue', 'tumgik', 'kukiit', 'sgsha', 'ogiikorel', 'raj', 'msawt', 'gaugn', 'smrgaki', 'kgmtu', 'vgsa', 'dipacademy', 'nngti', 'kamchatgtu', 'agiki', 'hgiik', 'tolgas', 'vlgafc', 'chgifkis', 'ael', 'pfa', 'dubna', 'chgiki', 'mgimo_odintsovo', 'rgiis', 'hmgma', 'yacayekaterinburg', 'spbau', 'kagms', 'rpa', 'spbpsysoc', 'msu', 'chifk', 'nes', 'dvart', 'mgu', 'bagsurb', 'krags', 'rostcons', 'mosconsv', 'egti', 'sarcons', 'usaaa', 'uralconsv', 'kazancons', 'sportacadem', 'magkmusic', 'marhi', 'vgik', 'theatrinsyar', 'gitis', 'asou', 'dvgafk', 'rachmaninov', 'rgufksmit', 'mguu', 'glazunovcons', 'sogpi', 'nsuada', 'sibsport', 'litinstitut', 'sgiismol', 'vgifk', 'ippolitovka', 'uralgufk', 'lesgaft', 'agprf']
result = []
